...
/**
 * ScrollReveal — React Bits word-by-word scroll-driven reveal (GSAP), ported
 * to TSX. Used for the Conservers detail copy so text sharpens/lights up as
 * you scroll it into view, instead of a generic fade-in-up.
 */
