...
/**
 * AcidSquares — React Bits raymarched lattice-corridor shader (ogl), ported to
 * TSX. Used as the Overview background. Colours are overridden from the call
 * site to the MetalDetect palette (the upstream defaults are violet/pink).
 */
